...
namespace Connect.Core
{
	public class GameplayManager : MonoBehaviour
	{
        ...
        [SerializeField] private TMP_Text winTiempo;
        ...
        [SerializeField] private TMP_Text _tiempoInicial;
        public bool backwards;
        [Tooltip("Si es al revés, configure el temporizador aquí.")] public float time;
        public int minutos, segundos;
        public float tiempoGanar;
        public TMP_Text _tiempoGanar;
        ...
        private void Update()
        {
            ...
            _tiempoInicial.text = string.Format("{0:00}:{1:00}", minutos, segundos);
        ...
        private void CheckWin()
        {
            ...
            winTiempo.text = "Te ha costado " + tiempoGanar;
            winTiempo.text = string.Format("Te ha costado " + "{0:00}:{1:00}", minutos, segundos) + "segundos";
