...
namespace Connect.Core
{
    public class GameManager : MonoBehaviour
    {
        ...
        {
            string levelName = "Nivel" + CurrentStage.ToString() + level.ToString();
        ...
        public void UnlockLevel()
        {
            ...
            string levelName = "Nivel" + CurrentStage.ToString() + CurrentLevel.ToString();
            PlayerPrefs.SetInt(levelName, 1);
        }
